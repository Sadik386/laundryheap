...
const Navbar = () => {
    ...
    return (
        <div className="w-full fixed top-0 z-50 transition-all duration-300">
            ...
            <nav className={`${isScrolled ? 'bg-white shadow-md py-2' : 'bg-[#111827] md:bg-transparent py-6'} w-full px-4 md:px-8 flex justify-between items-center transition-all duration-300`}>
